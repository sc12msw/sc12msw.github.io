    ...
    <div class="flex min-h-screen md:py-8">
      <div class="md:max-w-5xl max-w-full mx-auto bg-white relative flex-1">
        <Nav>
          ...
          <NavItem name="Education" :selected="false">
            <Education />
          </NavItem>
          <NavItem name="Skills" :selected="false">
            <section>
              ...
              Most recent project involved creation of a service to handle swipes from employees clocking into stores at Morrisons. Involved routing inputs from users between a legacy system and a new third party implementation to integrate with."
                highlights="Dropwizard, Jersey, Maven, Junit4, Springboot"
              />
              <Skill
                title="Python"
                :logoUrl="Python"
                ...
                highlights="Flask, Boto, Pytest BDD, Nose2"
              />
              <Skill
                title="Devops"
                :logoUrl="Devops"
                ...
                highlights="Terraform, Docker, Jenkins (multibranch pipelines), Kubernetes, GCP, AWS, Bash, Sonarqube"
              />
              <Skill
                title="WebDev"
                :logoUrl="Vuejs"
                ...
                highlights="Vuejs, Tailwind, Sass, Postcss, Gulp, Weback, Bootstrap, PHP"
              />
              <Skill
                title="Collaboration"
                :logoUrl="Atlassian"
                logoAlt="Atlassian Logo"
                detail="Jira tickets elaborated from architecture solutions, Auto building confluence documents from plant UML and Sphinx. Using smart commits using automatic time tracking with commit message syntax which is prevelant within the team. Negotiation and dealing with project managers, upper management and architects. Align well with Extreme Programming, have had the best experiences developing with TDD and XP."
                highlights="Jira, Confluence, Sphinx, Plant UML"
              />
            </section>
          </NavItem>
